...
```bash
git remote add encore encore://braida-beauty-marketplace-vrc2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/braida-beauty-marketplace-vrc2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/braida-beauty-marketplace-vrc2/settings/integrations/github)
